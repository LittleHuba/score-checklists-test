...
class TestCollectAcknowledgementDetails:
    def test_collects_marker_ack(self):
        ...
        pr = MagicMock()
        pr.get_issue_comments.return_value = [cl, ok]
    ...
    def test_collects_bare_ok(self):
        cl = _make_comment(
            100,
            "<!-- review-checklist:api-review -->",
            "bot",
    ...
    def test_no_acks(self):
        cl = _make_comment(100, "<!-- review-checklist:api-review -->", "bot")
        pr = MagicMock()
        pr.get_issue_comments.return_value = [cl]
