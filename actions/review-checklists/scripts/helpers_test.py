...
class TestFindExistingChecklistComments:
    def test_finds_checklist_comments(self):
        c1 = _make_comment(
        ...
        pr = MagicMock()
        pr.get_issue_comments.return_value = [c1, c2, c3]
...
class TestFindOkReplies:
    def test_finds_marker_based_ok(self):
        ...
        c1 = _make_comment(10, "checklist body", "bot")  # checklist comment
    ...
    def test_ignores_checklist_comment_itself(self):
        c1 = _make_comment(10, "OK", "bot")  # same id as checklist
        pr = MagicMock()
